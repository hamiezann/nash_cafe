            ...
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control p_input" name="email" value="{{ old('email') }}" required autocomplete="email">
                  </div>
                  <div class="form-group">
                  ...
                  <p class="sign-up text-center">Already have an Account?<a href="{{route('login.user')}}"> Sign In</a></p>
