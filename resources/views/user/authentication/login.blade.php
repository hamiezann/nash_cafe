                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <label>Email *</label>
                                    <input type="email" class="form-control p_input" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <p class="sign-up">Continue As Guest?<a href="{{route('home')}}"> Home</a></p>
                            </form>
                        </div>
                    </div>
                </div>
